declare class PSQLError extends import('@yo1dog/extendable-error') implements IPSQLErrorFields {
  public constructor(
    /**
...
declare interface IPSQLErrorMessageOptions {
  /**
 ...
 */
declare interface IQueryPositionDetail {
 ...
 */
declare interface IPSQLErrorFields {
...
declare enum PSQLErrorContextLevel {}
declare enum PSQLErrorVerbosityLevel {}

declare interface IPSQLConst {
